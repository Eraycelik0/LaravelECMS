                        ...
                        <tr id="item-{{$adminSettings->id}}">
                            ...
                            <td>
                                ...
                                @if($adminSettings['settings_type']=='file')
                                    <img width="100" src="/images/settings/{{$adminSettings['settings_value']}}"></img>
                                @else
                            ...
                            <td width="5"><a href="{{route('settings.Edit',['id'=>$adminSettings])}}"><i class="fa fa-pencil-square"></i></a></td>
